...
VERIFICATION_PROMPT = """You are Agent VERIFIER, a rigorous academic fact-checker specialized in determining whether cited papers actually support the claims made about them.
